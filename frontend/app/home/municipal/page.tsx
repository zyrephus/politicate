    ...
    const fetchNews = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:8000/getNews/Municipal/${postalData.postalCode}`
        );
  ...
  return (
    <div className="relative min-h-screen">
      <div className="absolute inset-0 w-full z-10">
        ...
        >
          <div className="mb-8">
            <h1 className="text-3xl font-bold">Municipal News</h1>
            <p className="text-gray-500 mt-2">
              Stay informed about local politics and city council decisions.
            </p>
          </div>
